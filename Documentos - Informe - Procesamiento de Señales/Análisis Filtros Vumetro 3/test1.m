...
hold on;
plot(f,abs(Z1),'LineWidth',0.5,'color','blue');
plot(f,abs(Z2),'LineWidth',0.5,'color','red');
plot(f,abs(Z3),'LineWidth',0.5,'color','yellow');
plot(f,abs(Z4),'LineWidth',0.5,'color','green');
plot(f,abs(Z5),'LineWidth',0.5,'color','cyan');
plot(f,abs(Z6),'LineWidth',0.5,'color','black');
plot(f,abs(Z7),'LineWidth',0.5,'color','magenta');
plot(f,abs(Z8),'LineWidth',0.5,'color','blue');
hold off;
legend('Banda 1', 'Banda 2', 'Banda 3', 'Banda 4', 'Banda 5', 'Banda 6', 'Banda 7', 'Banda 8');
